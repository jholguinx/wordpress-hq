...
function hq_location_map() {
	...
	<section id="locations">
	    <div class="container location-select-container wow bounceInDown animated" data-wow-offset="200" style="visibility: visible; animation-name: bounceInDown;">
	        <div class="row">
	    ...
	    <div class="map wow bounceInUp animated" data-wow-offset="100" style="visibility: visible; animation-name: bounceInUp;">
	        <div class="mapouter"><div class="gmap_canvas"><iframe width="600" height="550" id="gmap_canvas" src="https://maps.google.com/maps?q=3256%20NW%2024th%20St%20Rd%2C%20Miami%20Fl%2033142&t=&z=11&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe></div><style>.mapouter{position:relative;text-align:right;height:550px;width:100%;}.gmap_canvas {overflow:hidden;background:none!important;height:550px;width:100%;}</style></div>
	    </div>
	</section>

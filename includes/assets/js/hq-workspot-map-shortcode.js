...
if(hqMapLocationData[0].mapUUID){
    setMaps(hqMapLocationData[0]);
}
if(hqMapLocationData[0].hasFloors === '1'){
    var floors = Object.entries(hqMapLocationData[0].floors);
    floors.forEach(function(floor){
        if(floor[1].map){
            setFloor(floor[1], hqMapLocationData[0]);
        }
    });
}

...
function hq_reservation_form()
{
    ...
    ?>
    <section id="hq-reservation-form" class="elementor-section elementor-top-section elementor-element elementor-element-24d39dd elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-id="24d39dd" data-element_type="section">
                    ...
                    <div class="elementor-element elementor-element-af18c2b elementor-widget elementor-widget-templines-search" data-id="af18c2b" data-element_type="widget" data-widget_type="templines-search.default">
                        <div class="elementor-widget-container">
                            <form method="GET" action="/reservations/" >
                                <div class="l-section l-section--container c-filter c-filter--col-2 c-filter--layout-1" style="color:#ffffff;background-color:#0b4453;">
                                        ...
                                        <div class="c-filter__wrap">
                                            <div class="c-filter__field">
                                                ...
                                                <div class="c-filter__element">
                                                    ...
                                                    <input type="text" class="h-cb c-filter__date js-filter-date-range" value="" readonly="" style="color:rgba(255, 255, 255, 0.5)!important;background-color:rgb(28, 81, 95)!important;">
                                                </div>
                                            </div>
                                            ...
                                            <div class="c-filter__field">
                                                ...
                                                <div class="c-filter__element">
                                                    <select id="vehicle-class" name="vehicle_class_id" class="h-cb c-filter__select styled js-filter-type hasCustomSelect" style="color: rgba(255, 255, 255, 0.5) !important; background-color: rgb(28, 81, 95) !important; appearance: menulist-button; position: absolute; opacity: 0; height: 50px; font-size: 16px; width: 439px;">
                                                        <option value="">Select type</option>
                                                        <?php foreach ($vehicles as $vehicle): ?>
                                                            <option value="<?php echo $vehicle->id; ?>"><?php echo $vehicle->getLabel(); ?></option>
                                                        <?php endforeach; ?>
                                                    </select><span class="c-custom-select" style="color: rgba(255, 255, 255, 0.5) !important; background-color: rgb(28, 81, 95) !important; display: inline-block;"><span class="c-custom-selectInner" style="width: 439px; display: inline-block;" id="vehicle-tag">Select type</span><i class="ip-select c-custom-select__angle"><!-- --></i></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

                                    ...
                                    <div class="col-sm-6 col-md-6 col-md-offset-1">
                                        <div class="form-search dark">
                                            <form action="<?php echo $action; ?>">
                                                    ...
                                                    <div class="container-fluid">
                                                        <div class="col-sm-12">
                                                            <div class="form-group has-icon has-label">
                                                                ...
                                                                <input id="hq-email" required type="text" name="email" autocomplete="false" placeholder="<?php esc_html_e( 'Email', 'rentit' ); ?>" class="hq-text-inputs">
                                                ...
                                                <div class="row row-inputs">
                                                    ...
                                                    <div class="col-sm-6 date">
                                                            <div class="form-group has-icon has-label">
                                                                ...
                                                                <input readonly name="pick_up_date" type="text" autocomplete="off" class="form-control" id="hq-pick-up-date" placeholder="<?php esc_html_e( $pick_up_date_placeholder, 'rentit' ); ?>">
                                                    ...
                                                    <div class="container-fluid inputs-align">
                                                        <div class="col-sm-6 date">
                                                            <div class="form-group has-icon has-label">
                                                                ...
                                                                <input name="return_date" readonly type="text" autocomplete="off" class="form-control" id="hq-return-date" placeholder="<?php esc_html_e( $return_date_placeholder, 'rentit' ); ?>">
                                                                <span class="form-control-icon"><i class="fa fa-calendar"></i></span>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6 time">
                                                ...
                                                <!--    <div class="container-fluid"> -->
                                                <!--        <div class="col-sm-6">  -->
                                                <!--            <label><input required type="checkbox" id="terms" name="terms_and_conditions">-->
                                                <!--                <?php// esc_html_e( $terms_and_conditions_label, 'rentit' ); ?>-->
                                                <!--            </label>-->
                                                <!--         </div>   -->
                                                <!--    </div>-->
                                                <!--</div>-->
                                                ...
                                                <div class="row row-submit hq-row-submit">
                                                   ...
                                                   <?php if(get_locale() == 'nl_NL'){ echo 'Alle velden zijn verplicht*';}
                                                   else{ echo 'Alle Felder sind erforderlich*';}
                                                   ?>
                                                </div>

	            ...
	            <div class="row">
	                ...
	                <div class="col-md-5 col-xs-12 pull-left">
	                        ...
	                        <form action="/reservations-miami/" method="post" id="hq-booking-form">                 
	                        	...
	                        	<div class="location return brands brand-">
	                        		<div class="input-group margin-20">
		                                <span class="input-group-addon"><span class="glyphicon glyphicon-map-marker"></span><?php _e( 'Drop-off', 'fw' ) ?> </span>
										<div class="styled-select-car pickuplocation">
						...
						<div class="datetime pick-up">
							<div class="date pull-left">
								<div class="input-group">
									...
									<input type="text" name="pick_up_date" id="pick-up-date" class="form-control datepicker" placeholder="<?php echo fw_get_db_settings_option( 'date_format' ); ?>">
								</div>
							</div>
						...
						<div class="datetime drop-off">
							<div class="date pull-left">
								<div class="input-group">
									<span class="input-group-addon pixelfix"><span class="glyphicon glyphicon-calendar"></span><?php _e( 'Drop-off', 'fw' ) ?></span>
									<input type="text" name="return_date" id="drop-off-date" class="form-control datepicker" placeholder="<?php echo fw_get_db_settings_option( 'date_format' ); ?>">
								</div>
							</div>
							<div class="time pull-right">
								<div class="styled-select-time">

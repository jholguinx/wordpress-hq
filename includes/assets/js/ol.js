...
*/
    ...
    w(xb, wb);
    var Ab = 6378137 * Math.PI, yb = [-Ab, -Ab, Ab, Ab], zb = [-180, -85, 180, 85],
    ...
    function Ih(a) {
        ...
        if (this.l === Ph) {
            ...
            0 < g ? b.animate({
                ...
                anchor: this.a,
                duration: 500
            }) : 0 > g && b.animate({resolution: f, easing: Oe, anchor: this.a, duration: 500});
            this.f = a;
            return !1
        }
        this.j += d;
    ...
    var ei = [0, 0, 0, 1], fi = [], gi = [0, 0, 0, 1], hi = [0, 0, 0, 0], ii = new ci, ji = {}, ki = null, li = {},
        ni = function () {
            function a(a) {
                var b = mi();
    ...
    bj.prototype.$c = function (a, b) {
        var c = a.pixelRatio, d = a.size, e = a.viewState, f = e.center, g = e.resolution, h = this.a.ha(),
    ...
    mj.prototype.$c = function (a, b) {
        ...
        e = e.center;
        var h = this.a, l = h.ha(), m = l.g, n = l.eb(f), p = n.Dc(g, this.O), q = n.Ta(p), r = Math.round(g / q) || 1,
            u = a.extent;
        ...
        for (var l = !nb(d), m = 0, n = e.length, p = 0, q, r, u, v, z, A, E, S, Ia, ta = 0, la = 0, ca = null, ia = null, xa = a.Ub, Va = a.$, ic = {
            ...
            switch (Z[0]) {
                ...
                case 6:
                    ...
                    S = f ? null :
                        Z[6];
                    var rf = Z[7], yu = Z[8], zu = Z[9], Au = Z[10], Bu = Z[11], jp = Z[12], Cu = Z[13], Du = Z[14],
                        Eu = Z[15];
                    if (16 < Z.length) {
                        var kp = Z[16];
                        var lp = Z[17];
                ...
                case 5:
                    ...
                    S = f ? null : Z[4];
                    var Fu = Z[5], pp = Z[6], Gu = Z[7], qp = Z[8], rp = Z[9], sp = Z[10], tp = Z[11], up = Z[12],
                        Mk = Z[13], vp = Z[14], wp = tj(h, np, op, 2), xp = qp(up);
                    if (Fu || xp <= wp) {
                        a:{
                            var Ni = void 0, yp = void 0, Xf = void 0,
                                sf = h, ve = np, zp = op, Ap = up, Hu = qp, Bp = (wp - xp) * vj[a.s[Mk].textAlign],
                                Iu = Gu, Nk = [], Kh = sf[ve] > sf[zp - 2], Cp = Ap.length, Lh = sf[ve],
                                Mh = sf[ve + 1];
                            ve += 2;
    ...
    Rj.prototype.Y = function (a, b, c, d) {
        ...
        if (!ii.a.hasOwnProperty(e)) {
            var f = d ? this.ab[d] || this.g : null, g = c ? this.o[c] || this.c : null, h = this.s[b] || this.f,
    ...
    k.df = function (a, b, c) {
        var d = a.extent, e = a.pixelRatio, f = b.Te ? a.skippedFeatureUids : {}, g = a.viewState, h = g.projection,
            l = g.rotation, m = h.G(), n = this.a.ha(), p = $i(this, a, 0);
    ...
    k.Sf = function (a, b, c, d, e, f, g, h, l) {
        var m = a, n = this.a, p = b.pixelRatio, q = b.viewState.projection, r = n.g, u = n.get(ik) || null,
            v = mk(m, n);
    ...
    k.pf = function (a, b, c) {
        var d = this.a, e = d.D ? {} : null, f = d.ha(), g = d.l, h = lk[g], l = b.pixelRatio, m = b.viewState.rotation,
            n = b.size;
        if (m) {
    ...
    function Gk() {
        ...
        a.Point = [new Bk({
            image: new yk({radius: 6, fill: new zk({color: c}), stroke: new Ak({color: b, width: 1.5})}),
            zIndex: Infinity
        })];
    ...
    k.di = function (a) {
        ...
        if (!this.i || !Xb(this.i, f)) {
            var g = Ob("EPSG:4326"), h = f.G(), l = f.oe, m = bc(l, g, f), n = l[2], p = l[1], q = l[0], r = m[3],
                u = m[2], v = m[1];
            m = m[0];
            this.f = l[3];
            this.j = n;
    ...
    function Ol(a, b, c, d) {
        var e = a.D, f = a.C, g = a.height, h = a.oa, l = a.qa, m = a.opacity, n = a.T, p = a.O,
            q = a.rotateWithView ? 1 : 0, r = -a.rotation, u = a.scale, v = a.width, z = Math.cos(r);
        r = Math.sin(r);
    ...
    function Wl(a, b, c, d) {
        var e, f = a.a.length, g = a.b.length, h = "bevel" === a.c.lineJoin ? 0 : "miter" === a.c.lineJoin ? 1 : 2,
            l = "butt" === a.c.lineCap ? 0 : "square" === a.c.lineCap ? 1 : 2, m = Rl(b, c, d), n = g, p = 1;
        for (e = 0; e < c; e += d) {
            var q = f / 7;
            var r = u;
            var u = v || [b[e], b[e + 1]];
    ...
    Rm.prototype.add = function (a, b, c, d, e) {
        ...
        for (f = this.a.length; g < f; ++g) {
            ...
            if (h.width >= b + this.b && h.height >= c + this.b) return f = {
                ...
                width: h.width - b,
                height: h.height
            }, b = {x: h.x, y: h.y + d, width: b, height: h.height - d}, Sm(this, a, c, b)) : (c = {
                x: h.x + b,
                y: h.y,
                width: h.width - b,
                height: d
    ...
    k.Wb = function (a, b) {
        if (this.ta) {
            ...
            var f = Ym(this, b), g, h, l = Math.round(f[0] * this.ab - this.$),
                m = Math.round(f[1] * this.ra - this.ca), n = this.N.lineWidth / 2 * this.N.scale;
            f = 0;
    ...
    pn.prototype.Bg = function (a, b) {
        var c = this.c.g, d = a.pixelRatio, e = a.viewState, f = e.center, g = e.resolution, h = e.rotation, l = this.M,
            m = this.Mb, n = this.a.ha(), p = a.viewHints, q = a.extent;
    ...
    k.Bg = function (a, b, c) {
        var d = this.c, e = c.b, f = a.viewState, g = f.projection, h = this.a, l = h.ha(), m = l.eb(g),
            n = m.Dc(f.resolution), p = m.Ta(n), q = l.Zd(n, a.pixelRatio, g), r = q[0] / Ba(m.Za(n), this.O)[0],
            u = p / r, v = l.Xc(r) * l.Zf(g), z = f.center, A = a.extent, E = tc(m, A, n);
    ...
    var Op = {"http://www.opengis.net/gml": {surfaceMember: M(Kp.prototype.Ji), polygonMember: M(Kp.prototype.Ji)}},
        ...
        Np = {"http://www.opengis.net/gml": {exterior: M(Kp.prototype.Ii), interior: M(Kp.prototype.Ii)}}, Rp = {
            "http://www.opengis.net/gml": {
    ...
    var qq = {rte: kq, trk: mq, wpt: oq}, rq = N(eq, {rte: uo(kq), trk: uo(mq), wpt: uo(oq)}),
    ...
    var yq = ["text", "type"], xq = N(eq, {text: M(ip), type: M(ip)}),
        Dq = N(eq, "name cmt desc src link number type rtept".split(" ")), Eq = N(eq, {
            ...
            type: M(ip),
            rtept: xo(M(zq))
        }), Aq = N(eq, ["ele", "time"]), Fq = N(eq, "name cmt desc src link number type trkseg".split(" ")), Iq = N(eq, {
            name: M(ip),
            cmt: M(ip),
            desc: M(ip),
            src: M(ip),
    ...
    var Yq = /^B(\d{2})(\d{2})(\d{2})(\d{2})(\d{5})([NS])(\d{3})(\d{5})([EW])([AV])(\d{5})(\d{5})/,
        Zq = /^H.([A-Z]{3}).*?:(.*)/, $q = /^HFDTE(\d{2})(\d{2})(\d{2})/, ar = /\r\n|\r|\n/;
    k = Xq.prototype;
    k.fe = function (a, b) {
    ...
    function er(a) {
        ...
        fr || (gr = [255, 255, 255, 1], hr = new zk({color: gr}), ir = [20, 2], jr = kr = "pixels", lr = [64, 64], mr = "https://maps.google.com/mapfiles/kml/pushpin/ylw-pushpin.png", nr = .5, or = new dr({
            ...
            size: lr,
            src: mr
        }), pr = "NO_IMAGE", qr = new Ak({color: gr, width: 1}), rr = new Ak({
            color: [51, 51, 51, 1],
            width: 2
        }), sr = new J({font: "bold 16px Helvetica", fill: hr, stroke: rr, scale: .8}), tr = new Bk({
            fill: hr,
    ...
    var Yr = N(vr, {displayName: L(R), value: L(R)}), Vr = N(vr, {
        ...
        Jr = N(vr, {extrude: L(ap), tessellate: L(ap), altitudeMode: L(R)}), Fr = N(vr, {coordinates: vo(Br)}),
        Rr = N(vr, {
        ...
        })), Kr = N(vr, {coordinates: vo(Br)}), ds = N(vr, {href: L(Cr)}, N(ur, {x: L(dp), y: L(dp), w: L(dp), h: L(dp)})),
        es = N(vr, {
            Icon: L(function (a, b) {
    ...
    var Ps = N(vr, ["Document", "Placemark"]), Ss = N(vr, {
        ...
        }), $s = N(vr, ["color", "scale"]), at = N(vr, {color: M(ts), scale: M(Os)}), bt = N(vr, ["color", "width"]),
        ct = N(vr, {color: M(ts), width: M(Ip)}), Bs = N(vr, {LinearRing: M(Hs)}),
    ...
    var ht = yo("color"), dt = yo("Data"), Fs = yo("ExtendedData"), Ms = yo("innerBoundaryIs"), ws = yo("Point"),
        xs = yo("LineString"), Cs = yo("LinearRing"), ys = yo("Polygon"), Ns = yo("outerBoundaryIs");
    ...
    du.prototype.v = function (a, b, c, d) {
        var e = [], f = no("http://www.opengis.net/wfs", "Transaction"), g = d.version ? d.version : "1.1.0",
            h = "1.0.0" === g ? 2 : 3;
    ...
    var nv = [null, "http://www.opengis.net/wms"], fv = N(nv, {
        ...
        hv = N(nv, {Format: L(R), OnlineResource: L(cv)}), mv = N(nv, {Keyword: uo(R)});
    ...
    function xx(a) {
        ...
        var b = this.D(a), c = this.B(a), d = this.T(a), e = !b && !c && !d, f = a.map, g = this.f.ha().i, h = [],
            l = [];
        if (e) {
            lb(this.a);
    ...
    function dy(a, b, c, d, e, f, g, h, l, m, n) {
        ...
        h.c.forEach(function (a) {
            ...
            a = (e[0][0] -
                v[0]) / f;
            var n = -(e[0][1] - v[1]) / f, u = (e[1][0] - v[0]) / f, z = -(e[1][1] - v[1]) / f,
                Va = (e[2][0] - v[0]) / f, ic = -(e[2][1] - v[1]) / f;
            e = b[0][0];
            b = b[0][1];
            g -= e;
            h -= b;
    ...
    t("ol.source.WMTS.optionsFromCapabilities", function (a, b) {
        ...
        var e = 1 < c.TileMatrixSetLink.length ? "projection" in b ? mc(c.TileMatrixSetLink, function (a) {
            var c = hc(d, function (b) {
                ...
                }).SupportedCRS, e = Ob(c.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/, "$1:$3")) || Ob(c),
                f = Ob(b.projection);

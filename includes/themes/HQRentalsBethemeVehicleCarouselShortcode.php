...
class HQRentalsBethemeVehicleCarouselShortcode{
    ...
    public function renderShortcode($atts = [])
    {
        ...
        $atts = shortcode_atts(
            ...
            , $atts, 'hq_rentals_betheme_vehicles_carousel');
        ?>
                        ...
                        <div class="hq-slide-inner">
                            <div class="car-rental-item-image">
                                <a href="<?php echo $atts['rent_button_url']; ?>" title="View car">
                                    <img class="hq-slide-image" src="<?php echo $vehicle->getFeatureImage('500'); ?>" title="<?php echo $vehicle->name; ?>" alt="<?php echo $vehicle->name; ?>">
                                </a>
                            </div>
